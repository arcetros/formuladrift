...
const Footer = () => {
  return (
    <footer>
      <div className="mt-8 relative max-w-6xl mx-auto px-6 lg:px-4">
        {/* Top area */}
        <div className="grid grid-cols-12 gap-8 py-8 md:py-12 border-t border-gray-200">
          ...
          <div className="mt-1 col-span-11 md:col-span-3 lg:col-span-2">
            <h6 className="text-gray-800 font-medium mb-2">Championship</h6>
          ...
          {/* Third Block */}
          <div className="mt-1 col-span-11 md:col-span-3 lg:col-span-2">
            <h6 className="text-gray-800 font-medium mb-2">Recources</h6>
            <ul className="text-sm">
              <li className="mb-2">
                <span className="text-gray-600 hover:text-gray-900 transition duration-150 ease-in-out">
                  Partners / Sponsors
