export const HamburgerIcon = ({ styles }) => {
  return (
    <svg
      ...
      className={styles ? styles : 'w-8 h-8'}
      fill="none"
      viewBox="0 0 24 24"
      stroke="currentColor"
    >
  ...
  return (
    ...
    >
      ...
      <path
        ...
        fill="white"
      />
      <path d="M234.246 62.1131H132.946L137.146 13.8131H238.546L234.246 62.1131Z" fill="#E9272A" />
      <path
      ...
      <path
        ...
        fill="#FEFEFE"
      />
      <path d="M186.346 17.7131H193.046L189.546 58.1131H182.846L186.346 17.7131Z" fill="#FEFEFE" />
      <path
...
export const RightArrow = () => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      className="h-6 w-6 group-hover:text-gray-700"
      fill="none"
      viewBox="0 0 24 24"
      stroke="currentColor"
    >
...
export const youtube = () => {
  return (
    <svg
      className="md:w-4 h-5 w-5 lg:h-5  text-white fill-current hover:text-gray-200"
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 16 16"
    >
...
export const facebook = () => {
  return (
    <svg
      className="md:w-4 md:h-4 h-[1.1rem] w-5 lg:h-5  text-white fill-current hover:text-gray-200"
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24"
    >
...
export const instagram = () => {
  return (
    <svg
      className="md:w-4 md:h-4 h-5 w-5 lg:h-5  text-white fill-current hover:text-gray-200"
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 448 512"
    >
...
export const twitter = () => {
  return (
    <svg
      className="w-5 lg:h-5 md:w-4 md:h-4 text-white fill-current hover:text-gray-200"
      role="img"
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24"
    >
...
export const MenuAlt1 = () => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      className="h-5 w-6 text-white group-hover:text-black"
      fill="none"
      viewBox="0 0 24 24"
      stroke="currentColor"
    >
