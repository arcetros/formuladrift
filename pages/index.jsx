...
import { Layout, Hero, Schedule, Standings, Sponsors, League } from '../components'

export default function Home({ newPosts, currentSchedule }) {
  return (
    <Layout>
      <Hero posts={newPosts} />
      ...
      <div className="relative max-w-[105rem] lg:max-w-[60rem] xl:max-w-[105rem] w-full flex mx-auto my-12">
        <div className="mx-4 md:mx-12 lg:mx-0 xl:mx-44 w-full">
          <h1 className="font-primary font-bold text-white text-lg lg:text-xl mb-8">
            GET INVOLVED
          </h1>
...
export async function getStaticProps() {
  ...
  return {
    props: { newPosts, currentSchedule },
    revalidate: 1,
  }
}
